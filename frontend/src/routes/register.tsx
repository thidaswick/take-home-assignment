...
export const Route = createFileRoute("/register")({
  head: () => ({ meta: [{ title: "Create account — TaskFlow AI" }, { name: "description", content: "Create your TaskFlow AI account." }] }),
...
function RegisterPage() {
  ...
  async function onSubmit(v: z.infer<typeof schema>) {
    try {
      setLoading(true);
      await register({ firstName: v.firstName, lastName: v.lastName, email: v.email, password: v.password });
